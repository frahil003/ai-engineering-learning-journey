...
# Calculate cost
cost_imput_tokens = input_tokens * input_token_price
cost_output_tokens = output_tokens * output_token_price

cost = (input_tokens * input_token_price + output_tokens * output_token_price)
print(f"""
      cost input: {cost_imput_tokens}
      cost output: {cost_output_tokens}
      Estimated cost: ${cost}""")